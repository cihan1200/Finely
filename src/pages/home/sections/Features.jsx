...
const FEATURES = [
  {
    ...
    description: 'Log every income and expense in seconds. Filter, search and edit with ease across all your accounts.',
  ...
  },
  {
    ...
    description: 'See exactly where your money goes with live category charts updated in real time.',
  ...
  },
  {
    ...
    icon: faBell,
    title: 'Budget alerts',
    description: 'Set monthly limits per category and get warned before you overspend — never be surprised again.',
  ...
  },
  {
    ...
    description: 'Organise spending with colour-coded tags that make every transaction instantly readable.',
  ...
  },
  {
    ...
    icon: faFileExport,
    title: 'CSV export',
    description: 'Download all your data anytime. One click, every transaction, ready for your spreadsheet.',
    ...
    <section className={styles.section} id="features" ref={sectionRef}>
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.rows}>
          {FEATURES.map(({ step, icon, title, description, tag, Visual, flip, warning }, i) => (
            <div
              key={i}
            ...
            >
              <div className={styles.text}>
                ...
                <div className={`${styles.iconWrap} ${warning ? styles.iconWrapWarning : ''}`}>
      ...
      {rows.map((r, i) => (
        <div className={styles.txRow} key={i} style={{ '--i': i }}>
          <div className={styles.txIcon} data-sign={r.sign}>
            <FontAwesomeIcon
              icon={r.sign === 'income' ? faArrowUp : r.sign === 'expense' ? faArrowDown : faExclamation}
            />
          </div>
    ...
    <div className={styles.catsVisual}>
      {cats.map((c, i) => (
        <span
          ...
          style={{ background: c.bg, color: c.text, borderColor: c.border, '--pill-i': i }}
        >
          {c.label}
        </span>
      ))}
